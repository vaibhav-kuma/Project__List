...
<body>
    ...
    <div class="section">
        ...
        <p>By accessing and using {{ config('app.name') }} ("the Service"), you agree to be bound by these Terms of Service ("Terms"), our Privacy Policy, and our Acceptable Use Policy. If you do not agree to these terms, you may not use the Service.</p>
    ...
    <div class="section">
        ...
        <p>You agree to indemnify and hold harmless {{ config('app.name') }} from:</p>
        <ul>
        ...
        <p>{{ config('app.name') }} is not liable for:</p>
        <ul>
    ...
    <div class="legal-notice">
        ...
        <p><strong>By using {{ config('app.name') }}, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</strong></p>
    </div>
    ...
    @auth
        @if(!auth()->user()->terms_accepted_at)
            <div class="section" style="text-align: center;">
                <form method="POST" action="{{ route('legal.terms.accept') }}">
                    @csrf
        ...
        @else
            <div class="section highlight" style="text-align: center;">
                <p>You accepted these Terms on {{ auth()->user()->terms_accepted_at->timezone(config('app.timezone'))->format('F j, Y, g:i A') }}.</p>
            </div>
        @endif
    @endauth
</body>
