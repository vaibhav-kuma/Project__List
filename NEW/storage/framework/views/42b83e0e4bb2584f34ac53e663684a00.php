...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> - Professional Security Testing Platform</title>
        ...
        <footer class="bg-white border-t border-gray-200">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <div class="text-center text-gray-500">
                    <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. Professional security testing platform.</p>
                    <p class="mt-2">
...
<?php /**PATH F:\Resume\ninor_project\New\resources\views/welcome.blade.php ENDPATH**/ ?>